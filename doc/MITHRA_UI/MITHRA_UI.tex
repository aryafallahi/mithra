...
\begin{itemize}
	...
	\begin{enumerate}
	    ...
	    %
	    \begin{equation}
	    	f(t) = \displaystyle A_0 \cos( 2 \pi f (t - t_0) + \phi_\mathrm{CEP} ) e^{2 \ln 2 \: (t - t_0)^2/\sigma^2 } \left\{ \begin{array}{ll} e^{- (t - t_0-\tau/2)^2/(N/f)^2} & \|t-t_0\| \ \geq \tau/2 \\ 1.0 & \|t-t_0\| \ \leq \tau/2 \end{array} \right.
	...
	%
	\item {\tt \small \em sigma-inverse-gaussian} is the value of parameters $\sigma$ for the inverse-Gaussian pulse in (\ref{inverseGaussian}).
\end{itemize}
%
...
\begin{itemize}
	...
	\item {\tt \small \em CEP} is the carrier envelope phase $\phi_{\mathrm{CEP}}$ of the modulated signal in degrees.
	%
	\item {\tt \small \em sigma-inverse-gaussian} is the value of parameters $\sigma$ for the inverse-Gaussian pulse in (\ref{inverseGaussianE}).
	%
\end{itemize}
\end{enumerate}
