...
%
However, it leads to the invalidity of typical approximations that are originiated from these assumptions and typically considered in established FEL simulation tools.
%
...
%
Working on different aspects of the software to meet the needs of new project is an endless effort.
%
As a result, there still exist features that are foreseen to be implemented in the future.

A list of new features and applied changes in version 1.1 released with this manual is as the following:
%
\begin{itemize}
	...
	%
	\item Because of an application of the code, a new field type is added to the code named as confined-plane-wave is added. This is fundamentally similar to plane-wave that is confined to an elliptical region determined by the two radius parameters.
	%
...
\begin{itemize}
	...
	%
	\item Implementing a far-field transformation technique to more accurately estimate the radiated power. This will avoid the problem of power underestimation due to limited sampling plane of the power in front of the bunch.
	%
...
%
The source codes are available under the link https://github.com/aryafallahi/mithra.
%
