...
\begin{itemize}
	...
	%
	%
	\item {\tt \em \small lorentz-factor} is a the Lorentz factor of the moving mesh. If this value if not given the solver automatically computes an optimal value. It is generally recommended to leave this option so that the solver does the autoomatic computation. However, in some rare cases setting manually the Lorentz factor of the mesh is needed.
\end{itemize}
...
\begin{itemize}
	...
	%
	\item {\tt \small \em rising-cycles} is the number of cycles that it takes for the flattop pulse to reach the flat time interval. Default value is two cycles.
	%
...
\begin{itemize}
	...
	%
	\item {\tt \small \em rising-cycles} is the number of cycles that it takes for the flattop pulse to reach the flat time interval.
	%
