...
\begin{itemize}
	...
	\begin{enumerate}
	    ...
	    %
	    \begin{equation}
	    	f(t) = \displaystyle \frac{A_0 \cos( 2 \pi f (t - t_0) + \phi_\mathrm{CEP} ) }{\sqrt[\leftroot{-3}\uproot{3}4]{ (1+t^2/\sigma_1^2) (1+t^2/\sigma_1^2) } } \left\{ \begin{array}{ll} e^{- (t - t_0-\tau/2)^2/(N/f)^2} & \|t-t_0\| \ \geq \tau/2 \\ 1.0 & \|t-t_0\| \ \leq \tau/2 \end{array} \right.
